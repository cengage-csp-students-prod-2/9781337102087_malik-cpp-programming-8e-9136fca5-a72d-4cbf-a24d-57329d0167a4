...
int main() {
  ...
  cout << "time elapsed on myClock: " << myClock.timeElapsed() << endl
       << "time remaining on myClock: " << myClock.timeRemaining() << endl
       << "difference between myClock and yourClock: "
       << myClock.timeDifference(yourClock) << endl
       << endl
       << endl;
